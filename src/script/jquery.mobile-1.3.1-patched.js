	...
	$.mobile.zoom = $.extend( {}, {
		...
		disable: function( lock ) {
			if ( !disabledInitially && !$.mobile.zoom.locked ) {
				// WiseMove Patch: disable for flicker issue
...
(function( $, undefined ) {
	...
	$.widget( "mobile.popup", $.mobile.widget, {
		...
		_ignoreResizeEvents: function() {
            ...
            // WiseMove Patch: Fix for popup reposition
			this._ignoreResizeTo = setTimeout( function() { self._ignoreResizeTo = 0; }, 600000 );
		},
